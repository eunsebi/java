package com.eunsebi.macro.asset;
...
public class Setting {
	...
	private static int width = 1000, height = 360;
	...
	public static Rectangle topPanel = new Rectangle(0, 0, 1000, 30);
	// Body Panel
	public static Rectangle devicePanel = new Rectangle(10, 30, 1000, 270);
	public static Rectangle gameSettingPanel = new Rectangle(10, 30, 1000, 270);
	
	public static Rectangle bottomPanel = new Rectangle(10, 270, 1000, 50);

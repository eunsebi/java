...
public class EgovComIndexController implements ApplicationContextAware, InitializingBean {
	...
	public String weather(ModelMap model) {
		return "egovframework/com/weather";
	}
	...
	public String profile(ModelMap model) throws Exception {
		...
		LoginVO user = 
				(LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();	//session에서 Login정보 가져옴.
        ...
        /*int confmAtTotCnt = (Integer) egovRwardManageService.selectRwardManageConfmAtListTotCnt(user.getUniqId());
        model.addAttribute("RwardManageConfmAtCnt", confmAtTotCnt);*/
        
		return "egovframework/main/Profile";
	}
}

 ...
 * </pre>
 */
@Repository("yearlySchdulManageDao")
public class YearlySchdulManageDao extends EgovComAbstractDAO {
	...
	public List selectDeptSchdulManageMainList(Map map) throws Exception{
		 return  (List)list("YearlySchdulManage.selectDeptSchdulManageMainList", map);
	}
	...
	public List selectDeptSchdulManageRetrieve(Map map) throws Exception{
		 return  (List)list("YearlySchdulManage.selectDeptSchdulManageRetrieve", map);
	}
	...
	public YearlySchdulManageVO selectDeptSchdulManageDetailVO(YearlySchdulManageVO deptSchdulManageVO) throws Exception{
		return (YearlySchdulManageVO)select("YearlySchdulManage.selectDeptSchdulManageDetailVO", deptSchdulManageVO);
	}
	...
	public List selectDeptSchdulManageList(ComDefaultVO searchVO) throws Exception{
		return (List)list("YearlySchdulManage.selectDeptSchdulManage", searchVO);
	}
	...
	public List selectDeptSchdulManageDetail(YearlySchdulManageVO deptSchdulManageVO) throws Exception{
		return (List)list("YearlySchdulManage.selectDeptSchdulManageDetail", deptSchdulManageVO);
	}
	...
	public int selectDeptSchdulManageListCnt(ComDefaultVO searchVO) throws Exception{
		return (Integer)select("YearlySchdulManage.selectDeptSchdulManageCnt", searchVO);
	}
	...
	public void insertDeptSchdulManage(YearlySchdulManageVO deptSchdulManageVO) throws Exception{
		insert("YearlySchdulManage.insertDeptSchdulManage", deptSchdulManageVO);
	}
	...
	public void updateDeptSchdulManage(YearlySchdulManageVO deptSchdulManageVO) throws Exception{
		insert("YearlySchdulManage.updateDeptSchdulManage", deptSchdulManageVO);
	}
	...
	public void deleteDeptSchdulManage(YearlySchdulManageVO deptSchdulManageVO) throws Exception{
		// 일지 삭제
		delete("YearlySchdulManage.deleteDiaryManage", deptSchdulManageVO);
		// 부서일정 삭제
		delete("YearlySchdulManage.deleteDeptSchdulManage", deptSchdulManageVO);
	}
}

...
public class EgovDeptSchdulManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageMainList_t1.do")
	public String egovDeptSchdulManageListT1(
			@CommandMap Map<?, ?> commandMap,
			//Map commandMap,
    		ModelMap model)
    throws Exception {
		...
		hmParam.put("uniqId", (String)loginVO.getUniqId());
		hmParam.put("schdulDeptId", "ORGNZT_0000000000011");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageMainList_t2.do")
	public String egovDeptSchdulManageListT2(
			@CommandMap Map<?, ?> commandMap,
			//Map commandMap,
    		ModelMap model)
    throws Exception {
		...
		hmParam.put("uniqId", (String)loginVO.getUniqId());
		hmParam.put("schdulDeptId", "ORGNZT_0000000000000");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageMainList_common.do")
	public String egovDeptSchdulManageListCommon(
			@CommandMap Map<?, ?> commandMap,
			//Map commandMap,
    		ModelMap model)
    throws Exception {
		...
		hmParam.put("uniqId", (String)loginVO.getUniqId());
		hmParam.put("schdulDeptId", "ORGNZT_0000000000021");
    ...
    throws Exception {
		...
		****************************************************************** */
		...
		//LOGGER.info("Bgnde : {} ", listWeek.get(0));
		//LOGGER.info("Endde : {} ", listWeek.get(listWeek.size()-1));
    ...
    throws Exception {
        ...
        model.addAttribute("searchKeyword", commandMap.get("searchKeyword") == null ? "" : (String)commandMap.get("searchKeyword"));
        model.addAttribute("searchCondition", commandMap.get("searchCondition") == null ? "" : (String)commandMap.get("searchCondition"));
        model.addAttribute("groupId", commandMap.get("groupId") == null ? "" : (String)commandMap.get("groupId"));
        
        String groupCode = (String)commandMap.get("groupId");
        String imsi = "0";
        
        if (groupCode != null ) {
        	if(groupCode.equals(imsi)) {
        		commandMap.put("group", "OFF");
        	} else {
        		String groupId = egovMeetingManageService.selectGroupId(groupCode);
        		
        		commandMap.put("group", "ON");
        		commandMap.put("groupId", groupId);
        	}
        }
    	...
    	//공통코드  일정구분 조회
    	voComCode = new ComDefaultCodeVO();
    	voComCode.setCodeId("COM200");
    	listComCode = cmmUseService.selectCmmCodeDetail(voComCode);
    	model.addAttribute("groupCode", listComCode);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageDetailPopup.do")
    ...
    throws Exception {
		...
		String sLocationUrl = "egovframework/com/cop/smt/sdm/EgovDeptSchdulManageDetailPopup";

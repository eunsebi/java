package egovframework.com.cop.smt.yea.web;
...
@Controller
public class YearlySchdulManageController {

	private static final Logger LOGGER = LoggerFactory.getLogger(YearlySchdulManageController.class);
	...
	@Resource(name = "yearlySchdulManageService")
	private YearlySchdulManageService yearlySchdulManageService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cop/yea/EgovMain.do")
    public String egovMain(ModelMap model) throws Exception {
    	return "egovframework/com/cop/smt/yea/EgovMain";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cop/yea/EgovLeft.do")
    public String egovLeft(ModelMap model) throws Exception {
    	return "egovframework/com/cop/smt/yea/EgovLeft";
    }
	...
	@RequestMapping(value="/cop/smt/yea/YearlySchdulManageMainList.do")
    ...
    throws Exception {
		...
		hmParam.put("schdulDeptId", (String)loginVO.getOrgnztId());
		
		/*commandMap.put("uniqId", (String)loginVO.getUniqId());
		commandMap.put("schdulDeptId", loginVO.getOrgnztId());*/
		
		List<?> reusltList = yearlySchdulManageService.selectDeptSchdulManageMainList(hmParam);

		model.addAttribute("resultList", reusltList);

    	return "egovframework/com/cop/smt/yea/YearlySchdulManageMainList";
	...
	@RequestMapping(value="/cop/smt/yea/YearlySchdulManageListPopup.do")
	public String egovDeptSchdulManageListPopup(
			@ModelAttribute("searchVO") ComDefaultVO searchVO,
			@CommandMap Map<?, ?> commandMap,
			YearlySchdulManageVO deptSchdulManageVO,
    		ModelMap model)
    throws Exception {
        ...
        List<?> sampleList = yearlySchdulManageService.selectDeptSchdulManageList(searchVO);
        model.addAttribute("resultList", sampleList);

        model.addAttribute("searchKeyword", commandMap.get("searchKeyword") == null ? "" : (String)commandMap.get("searchKeyword"));
        model.addAttribute("searchCondition", commandMap.get("searchCondition") == null ? "" : (String)commandMap.get("searchCondition"));

        int totCnt = (Integer)yearlySchdulManageService.selectDeptSchdulManageListCnt(searchVO);
		paginationInfo.setTotalRecordCount(totCnt);
        model.addAttribute("paginationInfo", paginationInfo);

		return "egovframework/com/cop/smt/yea/YearlySchdulManageListPopup";
	}
	 ...
	 * @param searchVO
	 * @param commandMap
	 * @param yearlySchdulManageVO
	 * @param model
	 * @return "egovframework/com/cop/smt/yea/YearlySchdulManageDailyList"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/yea/YearlySchdulManageDailyList.do")
	public String egovDeptSchdulManageDailyList(
			@ModelAttribute("searchVO") ComDefaultVO searchVO,
			@CommandMap Map<String, String> commandMap,
			YearlySchdulManageVO yearlySchdulManageVO,
    		ModelMap model)
    throws Exception {
		...
		****************************************************************** */
		...
		List<?> resultList = yearlySchdulManageService.selectDeptSchdulManageRetrieve(commandMap);
	 ...
	 * @param deptSchdulManageVO
	 * @param model
	 * @return "egovframework/com/cop/smt/yea/YearlySchdulManageWeekList"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value="/cop/smt/yea/YearlySchdulManageWeekList.do")
	 ...
	 * @param deptSchdulManageVO
	 * @param model
	 * @return "egovframework/com/cop/smt/yea/YearlySchdulManageMonthList"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value="/cop/smt/yea/YearlySchdulManageMonthList.do")
	 ...
	 * @param deptSchdulManageVO
	 * @param model
	 * @return "egovframework/com/cop/smt/yea/YearlySchdulManageList"
	 * @throws Exception
	 */
	@IncludedInfo(name="년차일정관리", order = 321 ,gid = 41)
	@RequestMapping(value="/cop/smt/yea/YearlySchdulManageList.do")
	public String egovDeptSchdulManageList(
			@ModelAttribute("searchVO") ComDefaultVO searchVO,
			@CommandMap Map<?, ?> commandMap,
			YearlySchdulManageVO deptSchdulManageVO,
    ...
    throws Exception {
        ...
        List<?> resultList = yearlySchdulManageService.selectDeptSchdulManageList(searchVO);
        model.addAttribute("resultList", resultList);
	 ...
	 * @param commandMap
	 * @param model
	 * @return "egovframework/com/cop/smt/yea/YearlySchdulManageDetail"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/yea/YearlySchdulManageDetail.do")
    ...
    throws Exception {
		...
		String sLocationUrl = "egovframework/com/cop/smt/yea/YearlySchdulManageDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String)commandMap.get("cmd");

		if(sCmd.equals("del")){
			yearlySchdulManageService.deleteDeptSchdulManage(deptSchdulManageVO);
			sLocationUrl = "redirect:/cop/smt/yea/YearlySchdulManageList.do";
		}else{
	        ...
	        List<?> sampleList = yearlySchdulManageService.selectDeptSchdulManageDetail(deptSchdulManageVO);
	        model.addAttribute("resultList", sampleList);
		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/yea/YearlySchdulManageDetailPopup.do")
	public String egovDeptSchdulManageDetailPopup(
			@ModelAttribute("searchVO") ComDefaultVO searchVO,
			YearlySchdulManageVO deptSchdulManageVO,
			@CommandMap Map<?, ?> commandMap,
    		ModelMap model)
    throws Exception {
		...
		String sLocationUrl = "egovframework/com/cop/smt/yea/YearlySchdulManageDetailPopup";
		...
		if(sCmd.equals("del")){
	    	...
	    	System.out.println("id : " +deptSchdulManageVO.getSchdulId());
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "egovframework/com/cop/smt/yea/YearlySchdulManageModify"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value="/cop/smt/yea/YearlySchdulManageModify.do")
    ...
    throws Exception {
		...
		String sLocationUrl = "egovframework/com/cop/smt/yea/YearlySchdulManageModify";
    	...
    	YearlySchdulManageVO resultDeptSchdulManageVOReuslt = (YearlySchdulManageVO)yearlySchdulManageService.selectDeptSchdulManageDetailVO(deptSchdulManageVO);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/yea/YearlySchdulManageModifyActor.do")
	public String deptSchdulManageModifyActor(
			final MultipartHttpServletRequest multiRequest,
			ComDefaultVO searchVO,
			@CommandMap Map<?, ?> commandMap,
			@ModelAttribute("deptSchdulManageVO") YearlySchdulManageVO deptSchdulManageVO,
			BindingResult bindingResult,
    		ModelMap model)
    throws Exception {
        ...
        if(sCmd.equals("save")){
			...
			****************************************************************** */
        	...
        	// 일정관리정보 업데이트 처리
			****************************************************************** */
        	yearlySchdulManageService.updateDeptSchdulManage(deptSchdulManageVO);
        	sLocationUrl = "redirect:/cop/smt/yea/YearlySchdulManageList.do";
		}
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "egovframework/com/cop/smt/yea/YearlySchdulManageRegist"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/yea/YearlySchdulManageRegist.do")
    ...
    throws Exception {
		...
		String sLocationUrl = "egovframework/com/cop/smt/yea/YearlySchdulManageRegist";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return  "/cop/smt/yea/YearlySchdulManageRegist"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/yea/YearlySchdulManageRegistActor.do")
    ...
    throws Exception {
        ...
        if(sCmd.equals("save")){
        	...
        	yearlySchdulManageService.insertDeptSchdulManage(deptSchdulManageVO);
        	sLocationUrl = "redirect:/cop/smt/yea/YearlySchdulManageList.do";
        }

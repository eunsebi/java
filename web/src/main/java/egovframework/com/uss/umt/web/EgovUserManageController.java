...
public class EgovUserManageController {
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/umt/EgovAnonymouUserInsertView.do")
    public String insertAnonymouUserView(
            @ModelAttribute("userSearchVO") UserDefaultVO userSearchVO,
            @ModelAttribute("userManageVO") UserManageVO userManageVO,
            Model model
            )throws Exception {
        ...
        return "egovframework/com/uss/umt/EgovAnonymousUserInsert";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/umt/EgovAnonymousUserInsert.do")
    public String insertAnonymousUser(
            @ModelAttribute("userManageVO") UserManageVO userManageVO,
            BindingResult bindingResult,
            Model model
            )throws Exception {
    	...
    	return "egovframework/com/uss/umt/EgovDeptInsertSucess";
    }

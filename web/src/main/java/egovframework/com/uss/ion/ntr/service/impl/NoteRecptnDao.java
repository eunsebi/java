...
public class NoteRecptnDao extends EgovComAbstractDAO {
    ...
    public Map selectNoteRecptnDetail(NoteRecptn noteRecptn) throws Exception {
    	return (Map)select("NoteRecptn.selectNoteRecptnDetail", noteRecptn);
    }
    ...
    /**
     * MainPage(EgovMainView) 미개봉 받은쪽지함 갯수 조회한다.
     * @param uniqId
     * @return
     */
	public Integer selectNoteRecptnRelationCntOpenYn(String uniqId) {
		// TODO Auto-generated method stub
		return (Integer)getSqlMapClientTemplate().queryForObject("NoteRecptn.selectNoteRecptnRelationCntOpenYn", uniqId);
	}
}

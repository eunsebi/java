...
public class OnlinePollPartcptnDao extends EgovComAbstractDAO {
    ...
    public List selectOnlinePollManageList(ComDefaultVO searchVO) throws Exception {
        return (List)list("OnlinePollPartcptn.selectOnlinePollManageList", searchVO);
    }
    ...
    public int selectOnlinePollManageListCnt(ComDefaultVO searchVO) throws Exception {
        return (Integer)select("OnlinePollPartcptn.selectOnlinePollManageListCnt", searchVO);
    }
    ...
    public List selectOnlinePollManageDetail(OnlinePollPartcptn onlinePollPartcptn) throws Exception {
        return (List)list("OnlinePollPartcptn.selectOnlinePollManageDetail", onlinePollPartcptn);
    }
    ...
    public List selectOnlinePollItemDetail(OnlinePollPartcptn onlinePollPartcptn) throws Exception {
        return (List)list("OnlinePollPartcptn.selectOnlinePollItem", onlinePollPartcptn);
    }
    ...
    public List selectOnlinePollManageStatistics(OnlinePollPartcptn onlinePollPartcptn) throws Exception {
        return (List)list("OnlinePollPartcptn.selectOnlinePollPartcptnStatistics", onlinePollPartcptn);
    }
    ...
    public int selectOnlinePollResult( OnlinePollPartcptn onlinePollPartcptn) throws Exception{
    	return (Integer)select("OnlinePollPartcptn.selectOnlinePollResult", onlinePollPartcptn);
    }

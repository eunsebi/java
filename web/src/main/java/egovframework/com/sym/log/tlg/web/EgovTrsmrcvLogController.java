...
public class EgovTrsmrcvLogController {
	...
	public String selectTrsmrcvLogInf(@ModelAttribute("searchVO") TrsmrcvLog trsmrcvLog, 
	...
	public String addTrsmrcvLog(@ModelAttribute("searchVO") TrsmrcvLog trsmrcvLog, 
			ModelMap model) throws Exception{
	...
	public String insertTrsmrcvLog(@ModelAttribute("searchVO") TrsmrcvLog trsmrcvLog, 
		...
		if(isAuthenticated){
			...
			trsmrcvLog.setRqesterId(user.getUniqId());

...
public class EgovMenuCreateManageController {
	...
	public String selectMenuCreatSiteMapInsert(
		...
		/* 사이트맵 파일 생성 위치 지정 */
		String path = EgovMenuCreateManageController.class.getResource("").getPath().substring(0, EgovMenuCreateManageController.class.getResource("").getPath().lastIndexOf("WEB-INF"));

...
import egovframework.com.fp.service.dao.FloorPlanLoneMasterDAO;
...
@Service("FloorPlanLoneMasterService")
public class FloorPlanLoneMasterServiceImpl extends EgovAbstractServiceImpl
		implements FloorPlanLoneMasterService {

	@Resource(name = "FloorPlanLoneMasterDAO")
	private FloorPlanLoneMasterDAO masterDAO;
	...
	public Map<String, Object> selectMasterList(FloorPlanMasterVO searchVO)
			throws Exception {
		List<FloorPlanMasterVO> result = masterDAO.selectMasterList(searchVO);

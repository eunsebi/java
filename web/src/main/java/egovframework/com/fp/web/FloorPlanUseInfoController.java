...
@Controller
public class FloorPlanUseInfoController {

	@Resource(name = "FloorPlanUseInfoManageService")
	private FloorPlanUseInfoManageService bbsUseService;
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/com/fp/deleteBBSUseInf.do")
	public String deleteBBSUseInf(
			@ModelAttribute("searchVO") FloorPlanUseInfVO bdUseVO,
			@ModelAttribute("bdUseInf") FloorPlanUseInf bdUseInf,
		...
		return "forward:/com/fp/selectBBSUseInfs.do";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/com/fp/addBBSUseInf.do")
	public String addBBSUseInf(
		...
		return "egovframework/com/fp/EgovBoardUseInfRegist";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/com/fp/insertBBSUseInf.do")
	public String insertBBSUseInf(
			@ModelAttribute("searchVO") FloorPlanUseInfVO bdUseVO,
			@ModelAttribute("boardUseInf") FloorPlanUseInf boardUseInf,
	 ...
	 * @throws Exception
	 */
	@IncludedInfo(name = "게시판사용정보", order = 8, gid = 8)
	@RequestMapping("/com/fp/selectBBSUseInfs.do")
	public String selectBBSUseInfs(
		...
		return "egovframework/com/fp/EgovBoardUseInfList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/com/fp/updateBBSUseInf.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/com/fp/selectBBSUseInf.do")
	public String selectBBSUseInf(
			@ModelAttribute("searchVO") FloorPlanUseInfVO bdUseVO,
			ModelMap model, HttpServletRequest request) throws Exception {
		FloorPlanUseInfVO vo = bbsUseService.selectBBSUseInf(bdUseVO);
		...
		if ("SYSTEM_DEFAULT_BOARD".equals(vo.getTrgetId())) {
			if (vo.getBbsTyCode().equals("BBST02")) { // 익명게시판
				vo.setProvdUrl(request.getContextPath()
						+ "/com/fp/anonymous/selectFloorPlanList.do?bbsId="
						+ vo.getBbsId());
			} else {
				vo.setProvdUrl(request.getContextPath()
						+ "/com/fp/selectFloorPlanList.do?bbsId=" + vo.getBbsId());
			}
		}

		model.addAttribute("bdUseVO", vo);
		return "egovframework/com/fp/EgovBoardUseInfInqire";
	}
}

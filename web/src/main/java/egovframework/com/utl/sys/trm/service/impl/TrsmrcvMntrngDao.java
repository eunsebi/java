...
public class TrsmrcvMntrngDao extends EgovComAbstractDAO {
	...
	public TrsmrcvMntrng selectTrsmrcvMntrng(TrsmrcvMntrng trsmrcvMntrng)
	  throws Exception{
		return (TrsmrcvMntrng)select("TrsmrcvMntrngDao.selectTrsmrcvMntrng", trsmrcvMntrng);
	}
	...
	public TrsmrcvMntrngLog selectTrsmrcvMntrngLog(TrsmrcvMntrngLog trsmrcvMntrngLog)
	  throws Exception{
		return (TrsmrcvMntrngLog)select("TrsmrcvMntrngDao.selectTrsmrcvMntrngLog", trsmrcvMntrngLog);
	}
	 ...
	 * @exception Exception Exception
	 */
	public List selectTrsmrcvMntrngList(TrsmrcvMntrng searchVO)
	  throws Exception{
		return list("TrsmrcvMntrngDao.selectTrsmrcvMntrngList", searchVO);
	}
	...
	public int selectTrsmrcvMntrngListCnt(TrsmrcvMntrng searchVO)
	  throws Exception{
		return (Integer)select("TrsmrcvMntrngDao.selectTrsmrcvMntrngListCnt", searchVO);
	}
	 ...
	 * @exception Exception Exception
	 */
	public List selectTrsmrcvMntrngLogList(TrsmrcvMntrngLog searchVO)
	  throws Exception{
		return list("TrsmrcvMntrngDao.selectTrsmrcvMntrngLogList", searchVO);
	}
	...
	public int selectTrsmrcvMntrngLogListCnt(TrsmrcvMntrngLog searchVO)
	  throws Exception{
		return (Integer)select("TrsmrcvMntrngDao.selectTrsmrcvMntrngLogListCnt", searchVO);
	}
	 ...
	 * @exception Exception Exception
	 */
	public List selectCntcList(CntcVO searchVO)
	  throws Exception{
		return list("TrsmrcvMntrngDao.selectCntcList", searchVO);
	}
	...
	public int selectCntcListCnt(CntcVO searchVO)
	  throws Exception{
		return (Integer)select("TrsmrcvMntrngDao.selectCntcListCnt", searchVO);
	}

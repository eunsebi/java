...
function goRegiUsr() {
    ...
    // 업무사용자
        ...
        document.loginForm.action="<c:url value='/uss/umt/EgovAnonymouUserInsertView.do'/>";
        document.loginForm.submit();
    }
}
                        ...
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0" style="width:250px;margin-left:20px; background-repeat:no-repeat;">
                              <tr>
                                ...
                                <td  nowrap><input name="rdoSlctUsr" type="radio" value="radio" onClick="checkLogin('GNR');" style="border:0;background:#ffffff;" tabindex="1">일반</td>
                                ...
                                <td  nowrap><input name="rdoSlctUsr" type="radio" value="radio" checked onClick="checkLogin('USR');" style="border:0;background:#ffffff;" tabindex="3">업무</td>
                              </tr>
                              <tr>
                                <td height="1">&nbsp;</td>
                              </tr>
                                ...
                                <td>
                                    <table width="250" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        ...
                                        <td><input type="text" name="id" id="id" style="height: 16px; width: 85px; border: 1px solid #CCCCCC; margin: 0px; padding: 0px; ime-mode: disabled;" tabindex="4" maxlength="10" onKeyDown="javascript:if (event.keyCode == 13) { document.loginForm.password.focus(); }"/></td>
                                        <td/>
                                      </tr>
                                      <tr>
  ...
  <%-- <table width="700">
    ...
    <div id="new_footer_login">
    	<ul>
            ...
            <input type="text" id="message" size="${fn:length(message)*2 }" name="message" value="<c:out value='${message}'/>">
			</c:if>
    	</ul>
    </div>
</center>

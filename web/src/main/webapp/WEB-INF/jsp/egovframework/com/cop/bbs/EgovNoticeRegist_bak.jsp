		...
		<div class="list_ar">
			<ul class="table_list02">
				...
				<li class="b_name_100">
					...
					<input name="nttSj" type="text" size="60" style="background-color: white;" value=""  maxlength="60" title="제목입력" />
			...
			<ul class="table_list03">
				...
				<li class="b_name_100">
		    		...
		    		<input name="file_1" id="egovComFileUploader" type="file" style="background-color: white;" title="첨부파일입력"/>
				</li>
			</ul>
			</c:if>
			...
			<div class="content_01">
				...
				<div><img src="<c:url value='/' />images/egovframework/adt/gu_bot.gif" alt="내용바닥이미지" width="620" height="12"></div>
			</div>

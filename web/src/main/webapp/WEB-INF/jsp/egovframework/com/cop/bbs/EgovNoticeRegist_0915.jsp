...
<script type="text/javascript" src="<c:url value='/html/egovframework/com/cmm/utl/ckeditor/samples/js/sample.js'/>"></script> --%>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="generalTable">
	  <tr>
	    ...
	    <td width="80%" nowrap colspan="3">
			<c:if test="${bdMstr.bbsId == 'BBSMSTR_000000000002' || bdMstr.bbsId == 'BBSMSTR_000000000012'}">
			<select onchange="javascript:selectTitle(this[this.selectedIndex].value);">
	  ...
	  <c:if test="${bdMstr.bbsId == 'BBSMSTR_000000000002' || bdMstr.bbsId == 'BBSMSTR_000000000012'}">
	  <tr>
	  	<th width="23%" class="emphasisRight" nowrap>스켸쥴등록</th>
	  	<td>
	  		<input id="SchduleData_1" name="SchduleData_1" type="checkbox" value="1">에칭 스탭 비치
	  		<input id="SchduleData_2" name="SchduleData_2" type="checkbox" value="1">전열로 프로파일 비치
	  		<input id="SchduleData_3" name="SchduleData_3" type="checkbox" value="1">MIR,전열,박스오븐 프로파일 비치
	  	</td>
	  </tr>
	  </c:if>
	  <tr>

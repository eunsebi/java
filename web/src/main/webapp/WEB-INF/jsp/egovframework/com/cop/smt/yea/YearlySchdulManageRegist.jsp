...
function fn_egov_list_DeptSchdulManage(){
	location.href = "<c:url value='/cop/smt/yea/YearlySchdulManageList.do' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
...
<!-- 상단타이틀 -->
<form:form commandName="deptSchdulManageVO" action="${pageContext.request.contextPath}/cop/smt/yea/YearlySchdulManageRegistActor.do" name="deptSchdulManageVO" method="post" enctype="multipart/form-data">
<!--  상단 타이틀  영역 -->
  ...
  <tr>
    ...
    <td width="80%" >
		...
		<tr>
			...
			<form:input path="schdulChargerName" size="73" cssClass="txaIpt" readonly="true" maxlength="10" value="${loginVO.id }"/>
			</td>
       ...
       <form:hidden path="schdulChargerId" value="${loginVO.uniqId }" />

...
<body>
 	<form name="consumableInventoryVO" id="consumableInventoryVO" action="?" method="post">
		...
		<input type="hidden" name="codeId" id="consumable" value="<c:out value="${consumableInventoryVO.consumable }" />" />
		<input type="hidden" name="mode" id="mode" value="<c:out value="${consumableInventoryVO.mode }" />" />
		<div style="visibility:hidden;display:none;"><input name="iptSubmit" type="submit" value="전송" title="전송"></div>
	</form>
	<jsp:forward page="/com/cons/consumableUVRampUseRegister.do" />
</body>
</html>
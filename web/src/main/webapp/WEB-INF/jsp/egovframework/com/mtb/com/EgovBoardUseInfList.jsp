...
<script type="text/javascript">
	...
	function fn_egov_select_bbsUseInfs(pageNo){
		...
		document.frm.action = "<c:url value='/com/mtb/selectMTBoardUseInfs.do'/>";
		document.frm.submit();
	}
	function fn_egov_insert_addbbsUseInf(){
		document.frm.action = "<c:url value='/com/mtb/addMTBoardUseInf.do'/>";
		document.frm.submit();
	}
	function fn_egov_select_bbsUseInf(bbsId, trgetId){
		document.frm.bbsId.value = bbsId;
		document.frm.trgetId.value = trgetId;
		document.frm.action = "<c:url value='/com/mtb/selectMTBouardUseInf.do'/>";
		document.frm.submit();
	}
...
<form name="frm" method="post" action = "<c:url value='/com/mtb/selectMTBoardUseInf.do'/>">
	  ...
	  <th width="10%">
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      ...
	      <a href="<c:url value='/com/mtb/selectMTBoardUseInfs.do'/>" onclick="fn_egov_select_bbsUseInfs('1'); return false;">조회</a>
	      </span></td>
	      <td>&nbsp;&nbsp;</td>
	      <td><span class="button">
	      <a href="<c:url value='/com/mtb/addMTBoardUseInf.do'/>" onclick="fn_egov_insert_addbbsUseInf(); return false;">등록</a>
	      </span></td>
	    </tr>
	   </table>
	  </th>
	    ...
	    <c:choose>
	    	<c:when test="${useCommunity == 'true'}">
	    		<td class="lt_text" nowrap>
					...
					<a href="<c:url value='/com/mtb/selectMTBoardUseInf.do'/>?bbsId=<c:out value='${result.bbsId}'/>&amp;trgetId=<c:out value='${result.trgetId}'/>" onclick="">

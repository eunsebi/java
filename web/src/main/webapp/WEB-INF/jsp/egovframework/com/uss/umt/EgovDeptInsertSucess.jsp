        ...
        <td align="center"><table width="100%" border="0" cellspacing="9" cellpadding="0">
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center"><table width="520" border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    ...
                    <td width="399" align="left" class="lt_text2">가입 신청이 완료되었습니다.</td>
                  </tr>
                  <tr>
                    <td align="left" valign="top" class="lt_text5">가입 승인은 1~2일 소요됩니다.</td>
                  </tr>
                </table>
              ...
              <tr>
                <td align="center"><a href="${pageContext.request.contextPath}/"><img src="${pageContext.request.contextPath}/images/egovframework/com/cmm/go_history.jpg" width="90" height="29" border="0"/></a></td>
              </tr>
            </table>
              <br /></td>
          </tr>

...
function fn_egov_modify_DeptSchdulManage(){
	var vFrom = document.DeptSchdulManageForm;
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/cop/smt/yea/YearlySchdulManageModify.do' />";;
	vFrom.submit();
...
function fn_egov_delete_DeptSchdulManage(){
	...
	if(confirm("삭제 하시겠습니까?")){
		vFrom.cmd.value = 'del';
		vFrom.action = "<c:url value='/cop/smt/yea/YearlySchdulManageDetail.do' />";
		vFrom.submit();
	}else{
		vFrom.cmd.value = '';
	}
...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;Maint 년차일정 상세보기</td>
 </tr>
</table>
<!-- 줄간격조정  -->

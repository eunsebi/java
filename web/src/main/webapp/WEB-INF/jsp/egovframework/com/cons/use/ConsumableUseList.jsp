...
function fnTabMenuSelect(objArr){
	...
	if(objArr == 0){
		...
		document.getElementById("SchdulView").src="<c:url value='/com/cons/consumableCleanPaperUseRegister.do' />?codeId=COM110&consumable=CON20&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />";
		document.getElementById("tabMenu1").bgColor = '#BBBBBB';
	}else if(objArr == 2){
		document.getElementById("SchdulView").src="<c:url value='/com/cons/consumableCleanPaperUseRegister.do' />?codeId=COM120&consumable=CON30&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />";
		document.getElementById("tabMenu2").bgColor = '#BBBBBB';
	}else if(objArr == 3){
		document.getElementById("SchdulView").src="<c:url value='/com/cons/consumableCleanPaperUseRegister.do' />?codeId=COM130&consumable=CON50&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />";
		document.getElementById("tabMenu3").bgColor = '#BBBBBB';
	}else if(objArr == 4){
		document.getElementById("SchdulView").src="<c:url value='/com/cons/consumableCleanPaperUseRegister.do' />?codeId=COM140&consumable=CON60&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />";
		document.getElementById("tabMenu4").bgColor = '#BBBBBB';
	}else if(objArr == 5){
		document.getElementById("SchdulView").src="<c:url value='/com/cons/consumableCleanPaperUseRegister.do' />?codeId=COM150&consumable=CON70&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />";
		document.getElementById("tabMenu5").bgColor = '#BBBBBB';
	}else if(objArr == 6){
		document.getElementById("SchdulView").src="<c:url value='/com/cons/consumableCleanPaperUseRegister.do' />?codeId=COM160&consumable=CON50&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />";
	...
	<table border="0" cellspacing="0" cellpadding="0" summary="월별일정보기,주간별일정보기,일별일정보기 입니다."      >
		<tr>
			<td height="20px" width="100px" bgcolor="#DDDDDD" style="cursor:hand;cursor:pointer;" align="center" id="tabMenu0">
				<a href="<c:url value='/com/cons/consumableCleanPaperUseRegister.do' />?codeId=COM100&consumable=CON10&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />" target="SchdulView" onClick="fnTabMenuSelect(0);"><b>전열로</b></a>
			</td>
			...
			<td height="20px" width="100px"  bgcolor="#DDDDDD" style="cursor:hand;cursor:pointer;" align="center" id="tabMenu1">
				<a href="<c:url value='/com/cons/consumableCleanPaperUseRegister.do' />?codeId=COM110&consumable=CON20&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />" target="SchdulView" onClick="fnTabMenuSelect(1);"><b>DFR라미</b></a>
			</td>
			<td height="20px" width="1x" bgcolor="#FFFFFF" ></td>
			<td height="20px" width="100px" style="cursor:hand;cursor:pointer;" bgcolor="#DDDDDD" align="center" id="tabMenu2">
				<a href="<c:url value='/com/cons/consumableCleanPaperUseRegister.do' />?codeId=COM120&consumable=CON30&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />" target="SchdulView" onClick="fnTabMenuSelect(2);"><b>평행광노광기</b></a>
			</td>
			<td height="20px" width="1x" bgcolor="#FFFFFF"> </td>
			<td height="20px" width="100px" style="cursor:hand;cursor:pointer;" bgcolor="#DDDDDD" align="center" id="tabMenu3">
				<a href="<c:url value='/com/cons/consumableCleanPaperUseRegister.do' />?codeId=COM140&consumable=CON50&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />" target="SchdulView" onClick="fnTabMenuSelect(3);"><b>포토실버인쇄기</b></a>
			</td>
			<td height="20px" width="1x" bgcolor="#FFFFFF"> </td>
			<td height="20px" width="100px" style="cursor:hand;cursor:pointer;" bgcolor="#DDDDDD" align="center" id="tabMenu4">
				<a href="<c:url value='/com/cons/consumableCleanPaperUseRegister.do' />?codeId=COM190&consumable=CON60&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />" target="SchdulView" onClick="fnTabMenuSelect(4);"><b>MIR건조로</b></a>
			</td>
			...
			<td height="20px" width="100px" style="cursor:hand;cursor:pointer;" bgcolor="#DDDDDD" align="center" id="tabMenu5">
				<a href="<c:url value='/com/cons/consumableCleanPaperUseRegister.do' />?codeId=COM150&consumable=CON70&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />" target="SchdulView" onClick="fnTabMenuSelect(5);"><b>DI노광기</b></a>
			</td>
			</c:if>
			
			<td height="20px" width="1x" bgcolor="#FFFFFF"> </td>
			<td height="20px" width="100px" style="cursor:hand;cursor:pointer;" bgcolor="#DDDDDD" align="center" id="tabMenu6">
				<a href="<c:url value='/com/cons/consumableCleanPaperUseRegister.do' />?codeId=COM170&consumable=CON50&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />" target="SchdulView" onClick="fnTabMenuSelect(6);"><b>포토TR인쇄기</b></a>
			</td>
			<td height="20px" width="1x" bgcolor="#FFFFFF"> </td>
		</tr>
	</table>

...
function fnTabMenuSelect(objArr){
	...
	if(objArr == 0){
		document.getElementById("SchdulView").src="<c:url value='/cop/smt/yea/YearlySchdulManageMonthList.do' />";
...
<table width="100%" cellpadding="1" class="table-search" border="0">
 <tr>
  <td class="title_left">
  	<h1>
  		<img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;Maint 년차 일정관리 목록
  	</h1>
  </td>
  <tr>
  	<td height="10"></td>
...
<tr>
  <td height="20px" width="100px" bgcolor="#DDDDDD" style="cursor:hand;cursor:pointer;" align="center" id="tabMenu0"><a href="<c:url value='/cop/smt/yea/YearlySchdulManageMonthList.do' />" target="SchdulView" onClick="fnTabMenuSelect(0);"><b>월별일정보기</b></a></td>

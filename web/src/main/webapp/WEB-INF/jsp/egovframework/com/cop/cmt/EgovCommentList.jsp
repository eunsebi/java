...
<table width="100%" cellpadding="8" class="listTable">
	<tbody>
		<c:forEach var="result" items="${resultList}" varStatus="status">
			<tr>
				<td class="listLeft" width="88%" style="padding-left:10px;" nowrap>
		    		<c:choose>
		     		...
		     		<textarea class="textarea" readonly="true" style="width:100%;"><c:out value="${result.commentCn}" /></textarea>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="generalTable">
	<tr>
	    ...
	    <td width="80%" nowrap align="left">
	      <input name="wrterNm" type="text" size="20" style="background-color: white;" value='<c:out value="${searchVO.wrterNm}" />' maxlength="20" title="작성자이름입력">
	      <br>

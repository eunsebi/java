...
<body>
<!-- content start -->
        <form:form commandName="userManageVO" action="${pageContext.request.contextPath}/uss/umt/EgovAnonymousUserInsert.do" name="userManageVO" method="post" >
            <!-- 우편번호검색 -->
        ...
        <!-- 검색조건 유지 -->
        <input type="hidden" name="emplyrSttusCode" value="A" />

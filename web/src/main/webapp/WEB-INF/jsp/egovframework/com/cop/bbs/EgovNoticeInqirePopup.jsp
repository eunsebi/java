...
<script type="text/javascript">
	...
	function fn_egov_delete_notice(){
		document.frm.action = "/cop/bbs/adm/deleteBoardArticle.do";
		document.frm.submit();
	}
	function fn_egov_moveUpdt_notice(){
		document.frm.action = "/cop/bbs/adm/forUpdateBoardArticle.do";
		document.frm.submit();
	}
	function fn_egov_addReply(){
		document.frm.action = "/cop/bbs/adm/addReplyBoardArticle.do";
		document.frm.submit();
	}
</script>
...
<!-- 메인탑 컨텐츠 시작 -->
	...
	<div id="center_body" style="padding-left: 10px;">
<!-- 		<div class="intro_img">

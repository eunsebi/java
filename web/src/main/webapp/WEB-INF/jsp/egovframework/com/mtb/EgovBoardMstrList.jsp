...
<script type="text/javascript">
	...
	function fn_egov_insert_addBrdMstr(){
		document.frm.action = "<c:url value='/com/mtb/addMTBoardMaster.do'/>";
		document.frm.submit();
	}

	function fn_egov_select_brdMstr(pageNo){
		document.frm.pageIndex.value = pageNo;
		document.frm.action = "<c:url value='/com/mtb/SelectMTBoardMasterInfs.do'/>";
		document.frm.submit();
	}

	function fn_egov_inqire_brdMstr(bbsId){
		document.frm.bbsId.value = bbsId;
		document.frm.action = "<c:url value='/com/mtb/SelectMTBoardMasterInf.do'/>";
		document.frm.submit();
	}
</script>
...
<form name="frm" action="<c:url value='/com/mtb/SelectMTBoardMasterInfs.do'/>" method="post">
	  ...
	  <th width="10%">
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      ...
	      <td>&nbsp;&nbsp;</td>
	      <td><span class="button"><a href="<c:url value='/com/mtb/addMTBoardMaster.do'/>" onclick="fn_egov_insert_addBrdMstr(); return false;"><spring:message code="button.create"/></a></span></td>
	    </tr>
	   </table>
	  </th>
	 </tr>
		 ...
		 <c:forEach var="result" items="${resultList}" varStatus="status">
		  <tr>
		    ...
		    <td class="lt_text3" nowrap>
				...
				<a href="<c:url value='/com/mtb/SelectMTBoardMasterInf.do'/>?bbsId=<c:out value='${result.bbsId}'/>">

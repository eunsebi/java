...
<script type="text/javascript">
	...
	function fn_egov_insert_addBrdMstr(){
		document.frm.action = "<c:url value='/com/fp/addBBSMaster.do'/>";
		document.frm.submit();
	}

	function fn_egov_select_brdMstr(pageNo){
		document.frm.pageIndex.value = pageNo;
		document.frm.action = "<c:url value='/com/fp/SelectBBSMasterInfs.do'/>";
		document.frm.submit();
	}

	function fn_egov_inqire_brdMstr(bbsId){
		document.frm.bbsId.value = bbsId;
		document.frm.action = "<c:url value='/com/fp/SelectBBSMasterInf.do'/>";
		document.frm.submit();
	}
</script>
...
<form name="frm" action="<c:url value='/com/fp/SelectBBSMasterInfs.do'/>" method="post">
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%" class="title_left">
	   <h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;도면 관리 게시판 정보</h1>
	  </td>
		<td width="*" >
	  ...
	  <th width="10%">
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      ...
	      <td>
	      	<span class="button">
	      		<a href="<c:url value='/com/fp/addBBSMaster.do'/>" onclick="fn_egov_insert_addBrdMstr(); return false;"><spring:message code="button.create"/></a>
	      	</span>
	      </td>
	    </tr>
	   </table>
		 ...
		 <c:forEach var="result" items="${resultList}" varStatus="status">
		  <tr>
		    ...
		    <td class="lt_text3" nowrap>
				...
				<a href="<c:url value='/com/fp/SelectBBSMasterInf.do'/>?bbsId=<c:out value='${result.bbsId}'/>">

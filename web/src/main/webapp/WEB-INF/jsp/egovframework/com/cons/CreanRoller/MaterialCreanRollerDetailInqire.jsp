...
function fn_egov_regist_MaterialConsumption(){
	...
	document.frm.action = "/com/mat/MaterialCreanRollerRegister.do";
	document.frm.submit();	
...
function fn_egov_updt_MaterialConsumptionBasic(){
	...
	//alert("공사중!!!");
	document.frm.action = "/com/mat/updateMaterialCreanRollerCode.do";
	document.frm.submit();	
...
function fn_egov_inquire_MaterialConsumption(number,codeId) {		
	...
	document.frm.codeId.value = codeId;	
  	document.frm.action = "/com/mat/MaterialCreanRollerDetailInqire.do";
  	document.frm.submit();	
...
function fn_egov_select_noticeList(pageNo,codeId,mcode){
	...
	document.frm.action = "/com/mat/MaterialCreanRollerMachineList.do";
	document.frm.submit();
}
...
function fn_egov_delete_notice(cmd,number){
	...
	if(confirm("삭제 하시겠습니까?")){
		...
		vFrom.cmd.value = 'del';
		vFrom.action = "<c:url value='/com/mat/deleteMaterialCreanRollerCode.do' />";
		vFrom.submit();
	}else{
		vFrom.cmd.value = '';
	} */

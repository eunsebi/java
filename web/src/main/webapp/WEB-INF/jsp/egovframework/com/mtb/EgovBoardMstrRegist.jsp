...
<script type="text/javascript">
	function fn_egov_regist_brdMstr(){
		if (!validateMtboardMaster(document.boardMaster)){
			return;
		}
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			...
			form.action = "<c:url value='/com/mtb/insertMTBoardMasterInf.do'/>";
			form.submit();
		}
	}
	...
	function fn_egov_select_brdMstrList(){
		form = document.boardMaster;
		form.action = "<c:url value='/com/mtb/SelectMTBoardMasterInfs.do'/>";
		form.submit();
	}
...
<title>Maint Total 게시판 생성</title>
...
<form:form commandName="boardMaster" name="boardMaster" method="post" action="${pageContext.request.contextPath}/com/mtb/SelectMTBoardMasterInfs.do">

...
function fn_egov_select_noticeList(pageNo) {
	...
	document.consumableInventoryVO.action = "<c:url value='/com/cons/consumableCleanPaperUseRegister.do'/>";
...
function fn_save_ConsumableManage(form) {
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		if(!validateConsumableInventoryVO(form)){
			...
			/* if (con10 < 0 || con11 < 0 || con20 < 0 || con21 < 0 || con30 < 0 || con31 < 0 || con50 < 0 ||
					con51 < 0 || con60 < 0 || con61 < 0 || con62 < 0 || con70 < 0) { */
			if (imsi < 0) {
				alert("재고수량 확인 바랍니다");
...
<!-- 		<div class="intro_img">
	...
	<div style="float: left; width: 804px;">
		...
		<div class="board_title01">
			<ul style="padding-top: 5px;">
				...
				<li class="black_title_text" style="float: left;">
					...
					<font color="blue" size="3">크린페이퍼(유포지)</font> 사용 등록
				</li>
				</c:if>
		...
		<!-- 상단타이틀 -->
		<form:form commandName="consumableInventoryVO" action="${pageContext.request.contextPath}/com/cons/consumableCleanPaperUseRegisterActor.do" name="consumableInventoryVO" method="post">
			<form:hidden path="codeId"/>
			<form:hidden path="bbsId"/>
			<form:hidden path="schdulDeptId"/>
			<form:hidden path="consumableImsi"/>
			<form:hidden path="pm" value="N"/>
			<form:hidden path="mode" value="PAPER"/>

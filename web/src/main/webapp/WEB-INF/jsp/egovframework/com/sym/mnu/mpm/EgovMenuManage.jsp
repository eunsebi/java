...
<table width="820" cellpadding="2" class="table-search" border="0">
	<tr>
		<td class="title_left">
			<h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="" />&nbsp;메뉴관리리스트</h1>
		</td>
	</tr>
	<!-- Searcher -->
	<tr>
		<td width="100%">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-register" summary="메뉴관리 검색조건">
				<caption>메뉴관리 검색조건</caption>
				<tr>
					<th width="20%" height="40" class="" scope="row" >
						<label for="searchKeyword">메뉴명</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" />
					</th>
					<td width="70%">&nbsp;<input name="searchKeyword" type="text" size="85" value="${searchVO.searchKeyword }"  maxlength="60" title="검색조건"/></td>
					<td>
						<span class="button"><input type="submit" value="<spring:message code="button.inquire" />" onclick="selectMenuManageList(); return false;"/></span>
					</td>
            	</tr>
			</table>
		</td>
	...
	<tr>
		<td widht="100%">
			<table width="717" border="0" cellpadding="8" class="table-line" style="table-layout:fixed" summary="메뉴관리 목록 조회화면으로 메뉴ID,메뉴한글명,프로그램파일명,메뉴설명,상위메뉴ID로 구성.">

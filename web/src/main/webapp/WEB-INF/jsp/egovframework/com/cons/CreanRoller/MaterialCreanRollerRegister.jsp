...
<validator:javascript formName="consumablesManageVO" staticJavascript="false" xhtml="true" cdata="false"/> --%>

<script type="text/javascript">
function fn_egov_select_MaterialConsumptionList() {
	document.frm.action = "<c:url value='/com/mat/MaterialCreanRollerConsumption.do'/>";
	document.frm.submit();
}
...
function fn_egov_regist_MaterialConsumption() {
	...
	document.frm.action = "<c:url value='/com/mat/MaterialCreanRollerInsertArticle.do'/>";
	document.frm.submit();
...
<body>
	...
	<div id="center_body">
		...
		<form:form commandName="consumablesVO" name="frm" action="" method="post"> 
		
			<input name="codeId" type="hidden" value="<c:out value='${consumablesVO.codeId}'/>">
			...
			<div class="list_ar">
				...
				<ul class="table_list02">
					...
					<li style="width: 100px; text-align: left; float:left;">
						...
						<input name="dateBeginView" type="text" size="10" value=""  readOnly onClick="javascript:fn_egov_NormalCalendar(document.frm, document.frm.dateBgnde, document.frm.dateBeginView);" title="게시시작일자입력">

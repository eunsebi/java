...
<%@ taglib prefix="validator" uri="http://www.springmodules.org/tags/commons-validator" %>
			...
			<div id="tx_canvas" class="tx-canvas">
				<div id="tx_loading" class="tx-loading">
					<div>
						<img src="<c:url value='/html/egovframework/com/cmm/utl/daumeditor/images/icon/editor/loading2.png'/>" width="113" height="21" align="absmiddle"/>
					</div>
				</div>
			...
			<div id="tx_resizer" class="tx-resize-bar">
				...
				<img id="tx_resize_holder" src="<c:url value='/html/egovframework/com/cmm/utl/daumeditor/images/icon/editor/skin/01/btn_drag01.gif'/>" width="58" height="12" unselectable="on" alt="" />
			</div>
			<div class="tx-side-bi" id="tx_side_bi">
				<div style="text-align: right;">
					<%-- <img hspace="4" height="14" width="78" align="absmiddle" src="<c:url value='/html/egovframework/com/cmm/utl/daumeditor/images/icon/editor/editor_bi.png' />" /> --%>
					&nbsp;
				</div>
			</div>
				<!-- 편집영역 끝 -->
				...
				<div id="tx_attach_box" class="tx-attach-box">
					<div class="tx-attach-box-inner">
						<div id="tx_attach_preview" class="tx-attach-preview">
							<p></p>
							<img src="<c:url value='/html/egovframework/com/cmm/utl/daumeditor/images/icon/editor/pn_preview.gif' />" width="147" height="108" unselectable="on"/>
						</div>

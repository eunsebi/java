...
<body>
        <table width="800" cellpadding="8" class="table-search" border="0" summary="타이틀 기능을 제공한다.">
            <tr>
        ...
        <br/>
        <table width="800" cellpadding="8" border="0" class="table-line" summary="사용자 목록을 제공한다.">
            <thead>
                <tr>

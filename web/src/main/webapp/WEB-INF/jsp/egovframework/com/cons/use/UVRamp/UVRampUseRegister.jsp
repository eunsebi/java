...
function fn_egov_select_noticeList(pageNo) {
	...
	document.consumableInventoryVO.action = "<c:url value='/com/cons/consumableUVRampUseList.do'/>";
	document.consumableInventoryVO.submit();
...
<!-- 		<div class="intro_img">
	...
	<div style="float: left; width: 804px;">
		...
		<div class="board_title01">
			<ul style="padding-top: 5px;">
				...
				<li class="black_title_text" style="float: left;">
					...
					<font color="blue" size="3">UV Ramp & Hot Roller</font> 사용 등록
				</li>
				</c:if>
		...
		<!-- 상단타이틀 -->
		<form:form commandName="consumableInventoryVO" action="${pageContext.request.contextPath}/com/cons/consumableUVRampUseRegisterActor.do" name="consumableInventoryVO" method="post">
			<form:hidden path="codeId"/>
			<form:hidden path="bbsId"/>
			<form:hidden path="schdulDeptId"/>
			<form:hidden path="consumableImsi"/>
			<form:hidden path="pm" value="N"/>
			<form:hidden path="mode" value="UV"/>
		...
		<c:import url="/EgovPageLink.do?link=egovframework/com/cons/use/UVRamp/UVRamp_Head" />
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
			<tr>
				...
				<td width="30%" align="left">
					<select id="facility" name="facility" onchange="consumableCheck2()" style="background-color: white;">

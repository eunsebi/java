...
<script type="text/javascript">
	function fn_egov_updt_bbsUseInf(){
		...
		document.boardUseInf.action = "<c:url value='/com/fp/updateBBSUseInf.do'/>";
		document.boardUseInf.submit();
	}
	function fn_egov_select_bbsUseInfs(){
		document.boardUseInf.action = "<c:url value='/com/fp/selectBBSUseInfs.do'/>";
		document.boardUseInf.submit();
	}
...
<body>
<form name="boardUseInf" method="post" action="<c:url value='/com/fp/updateBBSUseInf.do'/>">
...
<div id="border" style="width:730px">
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>
	  		<img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;도면 관리 게시판 사용정보 수정
	  	</h1>
	  </td>
	 </tr>
	</table>
	...
	<tr>
      ...
      <a href="<c:url value='/com/fp/updateBBSUseInf.do'/>" onclick="fn_egov_updt_bbsUseInf(); return false;">수정</a>
      </span></td>
      <td width="10"></td>
      <td><span class="button">
      <a href="<c:url value='/com/fp/selectBBSUseInfs.do'/>" onclick="fn_egov_select_bbsUseInfs(); return false;">목록</a>
      </span></td>
	</tr>
	</table>
	</div>

...
<script type="text/javascript">
	function fn_egov_select_bbsUseInfs(){
		document.boardUseInf.action = "<c:url value='/com/mtb/selectMTBoardUseInfs.do'/>";
	...
	function fn_egov_regist_bbsUseInf(){
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			...
			document.boardUseInf.action = "<c:url value='/com/mtb/insertMTBoardUseInf.do'/>";
			document.boardUseInf.submit();
		}
	}
	...
	function fn_egov_inqire_bbsInf(){
		var retVal;
		var url = "<c:url value='/cop/com/openPopup.do' />?requestUrl=/com/mtb/SelectMTBoardMasterInfsPop.do&width=850&height=520";
...
<div id="border" style="width:730px">
	<table width="100%" cellpadding="8" class="table-search" border="0"  summary="게시판명, 커뮤니티 동호회 정보  입니다">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>
	  		<img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;Maint Total 게시판 사용등록
	  	</h1>
	  </td>
	 </tr>
	</table>
	...
	<tr>
      ...
      <a href="<c:url value='/com/mtb/selectMTBoardUseInfs.do'/>?searchCondition=1" onclick="fn_egov_select_bbsUseInfs(); return false;"><spring:message code="button.list" /></a>
      </span></td>
	</tr>
	</table>
	</div>

...
function fn_egov_open_Popup(cnt, esntlId){
	...
	*/
	...
	}else if(opener[1] == "typeSalarySchdule"){
		opener[0].document.getElementById("salaryChargerId").value = esntlId;
		opener[0].document.getElementById("salaryChargerName").value = document.getElementById("iptText_"+ cnt).value;
	}

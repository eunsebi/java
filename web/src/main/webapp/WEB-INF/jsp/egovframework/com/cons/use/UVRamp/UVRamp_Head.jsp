	...
	<table border="0" cellspacing="0" cellpadding="0" summary="월별일정보기,주간별일정보기,일별일정보기 입니다."      >
		<tr>
			<td height="20px" width="100px" bgcolor="#DDDDDD" style="cursor:hand;cursor:pointer;" align="center" id="tabMenu0">
				<a href="<c:url value='/com/cons/consumableUVRampUseRegister.do' />?codeId=COM120&mode=UV&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />" onClick="fnTabMenuSelect(0);"><b>평행광노광기</b></a>
			</td>
			...
			<td height="20px" width="100px"  bgcolor="#DDDDDD" style="cursor:hand;cursor:pointer;" align="center" id="tabMenu1">
				<a href="<c:url value='/com/cons/consumableUVRampUseRegister.do' />?codeId=COM180&mode=UV&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />" onClick="fnTabMenuSelect(1);"><b>UV 경화기</b></a>
			</td>
			<td height="20px" width="1x" bgcolor="#FFFFFF" ></td>
			
			<td height="20px" width="120px"  bgcolor="#DDDDDD" style="cursor:hand;cursor:pointer;" align="center" id="tabMenu1">
				<a href="<c:url value='/com/cons/consumableUVRampUseRegister.do' />?codeId=COM181&mode=UV&bbsId=<c:out value="${consumableInventoryVO.bbsId }" />" onClick="fnTabMenuSelect(1);"><b>SS라인 UV 경화기</b></a>
			</td>
			<td height="20px" width="1x" bgcolor="#FFFFFF" ></td>

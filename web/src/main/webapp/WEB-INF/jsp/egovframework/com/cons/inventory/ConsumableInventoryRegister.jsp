...
<div id="center_body">
	...
	<div class="intro_title">
		...
		<div class="intro_title_right">
			...
			HOME &gt; <span class="intro_title_right_text"> 소모품 등록</span>
		</div>
	...
	<div style="float: left; width: 804px;">
		...
		<div class="board_title01">
			<ul style="padding-top: 5px;">
				...
				<li class="black_title_text" style="float: left;"><font color="blue">T1</font> 소모품  <font color="red" size="5">등록</font></li>
				</c:if>
				<c:if test="${consumableInventoryVO.bbsId == 'CONS_002' }">
				<li class="black_title_text" style="float: left;"><font color="blue">T2</font> 소모품  <font color="red" size="5">등록</font></li>
				</c:if>
			</ul>
		</div>
	...
	<!-- 상단타이틀 -->
	<form:form commandName="consumableInventoryVO" action="${pageContext.request.contextPath}/com/cons/consumableInventoryRegisterActor.do" name="consumableInventoryVO" method="post">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
		...
		<tr>
			...
			<td width="30%" align="left">
				<form:input path="useCn" style="background-color: white;"/>
		...
		<tr>
			...
			<td width="30%" align="left">
				<form:input path="receiveName" style="background-color: white;"/>
		...
		<tr>
			...
			<td width="30%" colspan="3" align="left">
				<form:input path="note" size="35"  style="background-color: white;"/>
			</td>
		</tr>
	</table>

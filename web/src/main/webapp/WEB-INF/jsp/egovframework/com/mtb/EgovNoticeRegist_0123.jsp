...
<!-- 			<div class="intro_img">
		...
		<div class="intro_title">
   			<div class="intro_title_right"><div class="intro_title_right_h_img"><img src="<c:url value="/" />images/egovframework/adt/img_home.gif" width="11" height="11" alt="HOME이미지"></div> HOME &gt; <span class="intro_title_right_text"><c:out value='${bdMstr.bbsNm}'/></span></div>
  			</div>
		...
		<div class="list_ar">
			...
			<c:choose>
				<c:when test="${bdMstr.bbsAttrbCode == 'MTBBSA01'}">
					...
					<ul class="table_list03">
						<li class="b_name_55"><span class="b_name01">모델명</span></li>
						<li class="b_name_100">
			    			<input name="model" type="text" size="20" title="모델명"/>
						<span class="b_name01">Revision</span>
							<input name="rev" type="text" size="20" title="Revision">
						</li>
					</ul>
					<ul class="table_list03">
						<li class="b_name_55"><span class="b_name01">등록명</span></li>
						<li class="b_name_100">
			    			상판 <input name="name_01" type="text" size="30" title="상판등록명"/>
			    			하판 <input name="name_02" type="text" size="30" title="하판등록명"/>
						</li>
					</ul>
					<ul class="table_list03">
						<li class="b_name_55"><span class="b_name01">조건</span></li>
						<li class="b_name_100">
			    			광량 <input name="spec_01" type="text" size="10" title="광량"/>mJ&nbsp;
			    			파장 <input name="spec_02" type="text" size="10" title="파장"/>%&nbsp;
			    			offset <input name="spec_03" type="text" size="10" title="offset"/>
						</li>
					</ul>
					<ul class="table_list03">
						<li class="b_name_55"><span class="b_name01">사이즈</span></li>
						<li class="b_name_100">
			    			<input name="size" type="text" size="10" title="사이즈"/>
			    			<span class="b_name01">파일위치</span>
				...
				<input type="hidden" name="nttSj" value="PM 진행" />
					<ul class="table_list03">
						<li class="b_name_55">
							<span class="b_name01">공정
								<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시">
							</span>
						</li>
						<li class="b_name_100">
							<select id="kind" name="kind" path="kind" style="background-color: white;" onchange="onClick();">
								<option value="0">선택</option>
								<option value="1">DES</option>
								<option value="2">현상</option>
							</select>
			    			<form:errors path="kind" />
			    		<span class="b_name01">PM진행조</span>
					...
					<ul class="table_list03">
						<li class="b_name_55"><span class="b_name01">메인탱크</span></li>
						<li class="b_name_100">
							<input name="name_01" type="checkbox" value="0" id="checkName1All" onClick="fn_egov_checkAll_name_1();" title="전체호기"/>전체호기
						...
						<span class="b_name01">Zone 내부</span>
							<input name="name_02" type="checkbox" value="0" id="checkName2All" onClick="fn_egov_checkAll_name_2();" title="전체호기"/>전체호기
					...
					<ul class="table_list03">
						<li class="b_name_55"><span class="b_name01">하우징 필터</span></li>
						<li class="b_name_100">
			    			<input name="spec_01" type="checkbox" value="0" id="checkSpec1All" onClick="fn_egov_checkAll_spec_1();" title="전체호기"/>전체호기
			    		...
			    		<span class="b_name01">수세 필터</span>
			    			<input name="spec_02" type="checkbox" value="0" id="checkSpec2All" onClick="fn_egov_checkAll_spec_2();" title="전체호기"/>전체호기
			...
			<ul class="table_list03">
				...
				<li class="b_name_55"><span class="b_name01">첨부파일</span></li>
				<li class="b_name_100">

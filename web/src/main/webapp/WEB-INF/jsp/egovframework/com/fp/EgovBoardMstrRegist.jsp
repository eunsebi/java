...
<script type="text/javascript" src="<c:url value='/js/egovframework/com/com/fp/EgovBBSMng.js' />"></script>
...
<script type="text/javascript">
	function fn_egov_regist_brdMstr(){
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			...
			form.action = "<c:url value='/com/fp/insertBBSMasterInf.do'/>";
			form.submit();
		}
	}
	...
	function fn_egov_select_brdMstrList(){
		form = document.boardMaster;
		form.action = "<c:url value='/com/fp/SelectBBSMasterInfs.do'/>";
		form.submit();
	}
...
<form:form commandName="boardMaster" name="boardMaster" method="post" action="${pageContext.request.contextPath}/com/fp/SelectBBSMasterInfs.do">
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>
	  		<img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;도면 관리 게시판 생성
	  	</h1>
	  </td>
	 </tr>
	</table>

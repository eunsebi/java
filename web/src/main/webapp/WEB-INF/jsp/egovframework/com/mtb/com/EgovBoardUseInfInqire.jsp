...
<script type="text/javascript">
	function fn_egov_updt_bbsUseInf(){
		...
		document.boardUseInf.action = "<c:url value='/com/mtb/updateMTBoardUseInf.do'/>";
...
<title>Maint Total 게시판 사용정보 수정</title>
...
<body>
<form name="boardUseInf" method="post" action="<c:url value='/com/mtb/updateMTBoardUseInf.do'/>">
...
<div id="border" style="width:730px">
	...
	<tr>
      ...
      <a href="<c:url value='/com/mtb/updateMTBoardUseInf.do'/>" onclick="fn_egov_updt_bbsUseInf(); return false;">수정</a>
      </span></td>
      <td width="10"></td>
      <td><span class="button">
      <a href="<c:url value='/com/mtb/selectMTBoardUseInfs.do'/>" onclick="fn_egov_select_bbsUseInfs(); return false;">목록</a>
      </span></td>
	</tr>
	</table>
	</div>

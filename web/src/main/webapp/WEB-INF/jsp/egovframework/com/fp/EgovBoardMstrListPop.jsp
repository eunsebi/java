...
<script type="text/javascript">
	...
	function fn_egov_select_brdMstr(pageNo){
		...
		document.frm.action = "<c:url value='/com/fp/SelectBBSMasterInfsPop.do'/>";
		document.frm.submit();
	}
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	  	<h1>
	  		<img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목버튼이미지">&nbsp;도면 관리 게시판 정보
	  	</h1>
	  </td>
	  <th >
	  </th>

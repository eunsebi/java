...
<!--  상단타이틀 -->
<form:form commandName="deptSchdulManageVO" name="deptSchdulManageVO" action="${pageContext.request.contextPath}/cop/smt/yea/YearlySchdulManageModifyActor.do" method="post" enctype="multipart/form-data">
<!--  상단 타이틀  영역 -->
